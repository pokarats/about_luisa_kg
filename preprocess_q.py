...
def cla_parser():
    ...
    :return: parsed args
    """
    parser = argparse.ArgumentParser(description='Preprcoess Interiew Texts')
    ...
    parser.add_argument('-d', '--data_dir', type=str, default='interviews', help='Name of data directory')
