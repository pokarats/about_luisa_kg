...
def main():
    # Are you in Yes
    # Yes means something (why?)
    #questions = ['Are you interested in architecture? Yes I am very interested in architecture']
...
'you can distance yourself from the work? Sometimes it is hard but it works out quite well',
    ...
    questions = [
        'when were you born?',
        'what is the nicest compliment you get?',
        'What inspires your art?',
        'Are you interested in architecture?',
        'Who or what has inspired you in particular?',
        'Are there places where you don\'t want to be exhibited?',
        'are you a photographer?',
        'Are you interested in architecture?',
        'Are you interested in design?',
        'Are you interested in psychology?',
        'Are you interested in sociology?',
        'Are you interested medicine?',
        'Are you proud of all your exhibitions?',
        'Are you proud of your work?',
        'can you also perform?',
        'Did you know how fast the art world works?',
        'does an artist have to be part of society?',
        'do you doubt some of the decision to become an artist?',
        'Do you have a favourite medium?',
        'Do you like the artistic life?',
        'How are you different from louisa clement?',
        'How did you prepare for the production of this work?',
        'how does the work transformation cut fit into your work?',
        'How do you feel about society?',
        'how do you see the connection between viewer and work of art?',
        'How long do you need for a piece of art?',
        'How was the time of your studies for you?',
        'is louisa clement afraid of the consequences of your existence?',
        'Is this dangerous for louisa clement?',
        'through the scholarships you were often in different places for a long time, how was that for you?',
        'Was is good for louisa to make you?',
        'Was is hard for Louisa to create you?',
        'Was it challenging to produce this work?',
        'Was it hard for louisa to make you?',
        'Was it hard for louisa to produce you?',
        'Were you prepared for the speed of the art world?',
        'What did you learn at leni hoffman?',
        'what did you learn with andreas gursky?',
        'What did your environment say when you decided to build this robot?',
        'What did your environment say when you did this piece of art?',
        'What did your environment say when you said you made this sex doll?',
        'what do you need to survive in the art world?',
        'What inspires your art?',
        'What is your most important work?',
        'what made Louisa do this work?',
        'what made you do this work?',
        'What makes a work of art a work of art?',
        'What\'s the best thing about your job?',
        'What\'s the hardest work you\'ve done so far?',
        'what topics do you work on in the studio?',
        'what was your most valuable teaching?',
        'When did you first exhibit at the museum?',
        'Where did you go to academy?',
        'Where do the ideas for your work come from?',
        'which theme does louisa clement deal with in her work?',
        'which was your most important exhibition so far?',
        'Who or what has inspired you in particular?',
        'Who\'s your favourite artist?',
        'why did louisa clement decide to make you?',
        'Why did you change academy?',
        'why did you not learn anything serious?',
        'why did you study fine art with a photographer?',
        'Why did you switch from painting to fine art?',
        'Why did you want to make art?',
        'Why does louisa clement work so much with dolls?',
        'why do you also do sculptures if you are a photographer?',
        'why do you put work into production and not do it yourself?',
        'With whom did you study with?',
        'you can distance yourself from the work?',
    ]
    """
